...
class Sentence():
    ...
    def known_mines(self):
        ...
        """
        if len(self.cells) == self.count:  # all are mines if equal
            return self.cells
    ...
    def known_safes(self):
        ...
        """
        if self.count == 0:  # all are safe if 0
            return self.cells
        ...
        for i in range(len(self.knowledge)):
            for j in range(i + 1, len(self.knowledge)):
                if self.knowledge[i].cells < self.knowledge[j].cells:
                    inferred_sentence = Sentence(self.knowledge[j].cells - self.knowledge[i].cells,
                    ...
                    inferred_sentence = Sentence(self.knowledge[i].cells - self.knowledge[j].cells,
