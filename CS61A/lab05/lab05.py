...
def berry_finder(t):
    ...
    has_berry = label(t) == "berry"

    for branch in branches(t):
        has_berry = has_berry or berry_finder(branch)
...
def replace_loki_at_leaf(t, lokis_replacement):
    ...
    for branch in branches(t):
        root_branches.append(replace_loki_at_leaf(branch, lokis_replacement))

    return tree(label(t), root_branches)
...
def closer_city(lat, lon, city_a, city_b):
    ...
    return get_name(city_a) if distance(city_a, destination) < distance(city_b, destination) else get_name(city_b)
